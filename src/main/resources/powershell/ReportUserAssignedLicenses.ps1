...
$SkuDataPath = "C:\Work\NovusTechnicalServices\NTS-InformationTechnology\src\main\resources\csv\SkuDataComplete.csv"
$ServicePlanPath = "C:\Work\NovusTechnicalServices\NTS-InformationTechnology\src\main\resources\csv\ServicePlanDataComplete.csv"
...
ForEach ($Line2 in $ImportServicePlans) {
    $ServicePlanHashTable.Add([string]$Line2.ServicePlanId, [string]$Line2.ServicePlanDisplayName)
}
...
ForEach ($User in $Users) {
    ...
    If ([string]::IsNullOrWhiteSpace($User.licenseAssignmentStates) -eq $False) {
        ...
        Where-Object {
            $null -ne $_.AssignedByGroup -and $_.State -eq "Active"
        }
        ...
        Where-Object {
            $Null -ne $_.AssignedByGroup -and $_.State -eq "Error"
        }
        ...
        Where-Object {
            $null -eq $_.AssignedByGroup -and $_.State -eq "Active"
        }
